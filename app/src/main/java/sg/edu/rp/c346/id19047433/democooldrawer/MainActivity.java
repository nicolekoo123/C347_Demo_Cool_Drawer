package sg.edu.rp.c346.id19047433.democooldrawer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Name out what thing to list in the array
        drawerItems = new String[] {
          "Bio", "Vaccination", "Anniversary"
        };

        //actionBar call for actionBar
        ab = getSupportActionBar();

        //Set the arrayAdapter to bing with the array drawItems
